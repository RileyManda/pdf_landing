...
class BlogDetailLeftSidebar extends Component {
  render() {
                ...
                <div className="entry-wrapper">
                  <div className="entry-single">
                    ...
                    <div className="entry-content">
                      ...
                      <p>
                        Claritas est etiam <span>processus dynamicus</span>, qui
                      ...
                      <blockquote>
                        ...
                        <span>
                          John Dow <span>Company Name</span>
                        </span>
                      </blockquote>
                      <p>
                        Lorem ipsum dolor sit amet, consectetuer adipiscing
                  ...
                  <div className="comment-section pt--70 pb--40">
                    <h5 className="comment-title mb--30">
                      <FaRegCommentAlt /> 26 Comments
                    </h5>
                    <CommentList />
                  </div>
                  ...
                  <div className="response-comment-section pb--30">
                    <h5 className="response-commen-title mb--30">
                      Leave A Comments
                    </h5>
                    <ContactForm2 />
                  </div>
